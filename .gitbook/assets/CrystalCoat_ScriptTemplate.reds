...
public class Utils extends ScriptableSystem {
  ...
  public func CustomizeMesh(vehicleModel: ESupportedVehicle, ccEnabled: Bool, meshComp: ref<MeshComponent>, components: array<ref<IComponent>>) -> ref<IComponent> {
    ...
    let currentInsertsChoice: EMeshAppearance = ccEnabled ? EMeshAppearance.Coated : EMeshAppearance.Standard;
    ...
    switch currentInsertsChoice {
      case EMeshAppearance.Standard:
        meshComp.meshAppearance = n"standard";
        break;
        
      case EMeshAppearance.Coated:
        meshComp.meshAppearance = n"coated";
        return widget;
        break;
    }
...
public class VehicleWatcher extends ScriptableSystem {
  ...
  private func ProcessEvent(event: ref<EntityLifecycleEvent>) {
    ...
    if entity.GetTemplatePath() == r"base\\vehicles\\standard\\v_standard25_mahir_supron_01__basic_01.ent"
    && Equals(entity.GetCurrentAppearanceName(), n"mahir_supron__basic_player_01") {
