...
public class Utils extends ScriptableSystem {
  ...
  public static func Get(gi: GameInstance) -> ref<Utils> {
    return GameInstance.GetScriptableSystemsContainer(gi).Get(n"MyNickName.MyModName.Utils") as Utils;
  }
...
public class VehicleWatcher extends ScriptableSystem {
  ...
  public static func Get(gi: GameInstance) -> ref<VehicleWatcher> {
    let ref = GameInstance.GetScriptableSystemsContainer(gi).Get(n"MyNickName.MyModName.VehicleWatcher") as VehicleWatcher;
    ref.Initialize();
