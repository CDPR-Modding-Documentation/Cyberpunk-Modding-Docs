...
* If you're making a weapon, check [weapons](weapons/ "mention"), or the more elaborate [new-iconic-weapon-step-by-step.md](weapons/new-iconic-weapon-step-by-step.md "mention") guide.
...
2. **appearance.app**: (only for non-dynamic variants) Adding a mapping between root\_entity and mesh's appearance
3. **root\_entity.ent**: (only for non-dynamic variants) Adding a mapping between yaml's appearance and app's appearance
4. \*_.mesh_:
...
{% hint style="info" %}
If your item is using [dynamic appearance](../../../for-mod-creators-theory/core-mods-explained/archivexl/#dynamic-variants) (true for items generated by WKit), you can skip this step.

If you want to convert an item, make sure to add the `DynamicAppearance` tag here.
{% endhint %}
