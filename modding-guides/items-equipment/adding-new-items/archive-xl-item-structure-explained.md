...
{% hint style="info" %}
The inherited properties can cause problems (see "[**Suffixes, and whether you need them**](../../../modding-know-how/files-and-what-they-do/entity-.ent-files/.ent-files-suffixes.md)" for more detail).&#x20;
...
{% hint style="warning" %}
You don't need to know [what suffixes are](../../../modding-know-how/files-and-what-they-do/entity-.ent-files/.ent-files-suffixes.md) unless you want to make variants for different genders or camera types. In fact, you will want to skip this until you have a confirmed and working mod!
...
Full documentation of [mesh\_entity](../../../modding-know-how/files-and-what-they-do/entity-.ent-files/#mesh-component-entity-simple-entity)\
More intel on [components](../../../modding-know-how/files-and-what-they-do/components/)
