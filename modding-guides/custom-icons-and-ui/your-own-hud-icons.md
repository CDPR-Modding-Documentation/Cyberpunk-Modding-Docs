...
1. Download the correct template from the wiki's [github repository](../../_resources_and_assets/icons). For a hudicon, that's [weapons\_hudicon.zip](https://github.com/CDPR-Modding-Documentation/Cyberpunk-Modding-Docs/blob/main/_resources_and_assets/icons/weapon_hudicon.zip)
