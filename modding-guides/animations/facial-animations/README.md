...
<figure><img src="../../../.gitbook/assets/image (547).png" alt=""><figcaption><p>The Relationships (as far as I can tell from FAFO so far) between scene node, dialog event to sound/anim files</p></figcaption></figure>
