...
This is where suffixes come in. You append them to an appearance's name in the [root\_entity](./#root-entity), and the game will pick the correct appearance (and the correct [app file](../../../developers/vehicles/archive/.app-file-appearanceresource.md), and the correct [mesh](../../3d-modelling/meshes.md)!) based on the best match.
