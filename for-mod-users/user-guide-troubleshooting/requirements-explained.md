...
The example will use [Virtual Atelier](https://www.nexusmods.com/cyberpunk2077/mods/2987?tab=description), but the same principle applies to each and any mod.
...
Cyberpunk 2077 offers native modding support via [redmod](../users-modding-cyberpunk-2077/redmod/ "mention"), but it is limited.
...
{% hint style="info" %}
* if you're debugging an Atelier Store, start with [Virtual Atelier ](https://www.nexusmods.com/cyberpunk2077/mods/2987)as a dependency.
{% endhint %}
...
Something is wrong with the mod itself. [You can now go and troubleshoot it](./#dealing-with-broken-mods).
...
Warnings in the log file don't necessarily mean that something is outright broken. But since you're here and your mod isn't working, that is probably the case. Proceed with [troubleshooting](./#dealing-with-broken-mods).
