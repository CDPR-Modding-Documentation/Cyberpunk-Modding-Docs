...
{% hint style="success" %}
If the place you're looking for isn't yet on the list, check the [finding-world-sectors.md](finding-world-sectors.md "mention") for instructions on how to find it. Please consider [**signing up and adding it**](https://app.gitbook.com/invite/-MP5ijqI11FeeX7c8-N8/H70HZBOeUulIpkQnBLK7) or find us on [Discord](https://discord.gg/redmodding) to leave your findings in the `#world-editing` channel.
{% endhint %}
