...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| GlobalNormal    | path\to\normal.xbm                                                                                                            |
| MultilayerMask  | path\to\mask.mlmask ([white file](../references-lists-and-overviews/materials/cheat-sheet-materials.md#white-multilayermask)) |
...
For a list of such templates, check [here.](../references-lists-and-overviews/materials/cheat-sheet-materials.md#emissive-materials)&#x20;
