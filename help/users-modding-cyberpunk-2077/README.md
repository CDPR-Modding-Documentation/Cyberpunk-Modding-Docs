...
If REDmod is not installed and activated, your mods will not load. For instructions on how to do that, see [here](../../modding-know-how/frameworks/redmod/#installation).
