...
* For instructions on how to activate it, see [here for GOG](getting-started/) and here for [Steam and Epic](../../modding-know-how/core-mods-explained/redmod/usage.md#steam-and-epic).
